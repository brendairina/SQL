...
DELETE FROM PRODUCTOS WHERE PRECIO_VENTA = 1;
DELETE FROM PRODUCTOS WHERE PRECIO_VENTA <>0 ;
TRUNCATE PRECIO_VENTA FROM PRODUCTOS;
...
as (select cantidad , precio , precio_total from compras);
 ...
 select ID_VENTAS, CANTIDAD , PRECIO , PRECIO_TOTAL
